...
NexT.utils = NexT.$u = {
  ...
  wrapImageWithFancyBox: function () {
    $('.content img')
      ...
      .each(function () {
        ...
        if (imageTitle) {
          $imageWrapLink.append('<p class="image-caption">' + imageTitle +
            '</p>');
  ...
  registerTabsTag: function () {
    ...
    $(function () {
      $(window).bind('hashchange', function () {
        ...
        if (tHash !== '') {
          $(tNav + 'li:has(a[href="' + tHash + '"])').addClass(
            'active').siblings().removeClass('active');
          $(tHash).addClass('active').siblings().removeClass(
            'active');
        }
      }).trigger('hashchange');
    });
  ...
  embeddedVideoTransformer: function () {
    ...
    $iframes.each(function () {
      ...
      if (this.src.search(pattern) > 0) {
        ...
        (wrap.style.paddingTop === '') && (wrap.style.paddingTop =
          '50%');
        ...
        if (this.src.search('music.163.com') > 0) {
          ...
          if (shouldRecalculateAspect) {
            wrap.style.paddingTop = getAspectRadio(newDimension.width,
              oldDimension.height) + '%';
          }
        }
      }
  ...
  addActiveClassToMenuItem: function () {
    ...
    $('.menu-item a[href^="' + path + '"]:first').parent().addClass(
      'menu-item-active');
  },
  ...
  getContentVisibilityHeight: function () {
    var docHeight = $('#content').height(),
      ...
      contentVisibilityHeight = (docHeight > winHeight) ? (docHeight -
        winHeight) : ($(document).height() - winHeight);
  ...
  getSidebarSchemePadding: function () {
    var sidebarNavHeight = ($('.sidebar-nav').css('display') == 'block') ?
      $('.sidebar-nav').outerHeight(true) : 0,
...
$(document).ready(function () {
  ...
  function initSidebarDimension() {
    ...
    if ($('.sidebar-panel').height() > (document.body.clientHeight - NexT.utils
