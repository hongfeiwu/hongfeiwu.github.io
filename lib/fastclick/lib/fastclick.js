...
(function () {
   ...
   * @type boolean
   */
  var deviceIsIOS4 = deviceIsIOS && (/OS 4_\d(_\d)?/).test(navigator
    .userAgent);
  /**
   ...
   * @type boolean
   */
  var deviceIsIOSWithBadTarget = deviceIsIOS && (/OS [6-7]_\d/).test(navigator
    .userAgent);
  /**
  ...
  FastClick.prototype.focus = function (targetElement) {
    ...
    if (deviceIsIOS && targetElement.setSelectionRange && targetElement.type
      .indexOf('date') !== 0 && targetElement.type !== 'time' &&
  ...
  FastClick.prototype.onTouchStart = function (event) {
    ...
    if (deviceIsIOS) {
      ...
      if (!deviceIsIOS4) {
        ...
        if (touch.identifier && touch.identifier === this
          .lastTouchIdentifier) {
  ...
  FastClick.prototype.onTouchMove = function (event) {
    ...
    if (this.targetElement !== this.getTargetElementFromEventTarget(event
        .target) || this.touchHasMoved(event)) {
      this.trackingClick = false;
      this.targetElement = null;
    }
    return true;
  ...
  FastClick.prototype.onTouchEnd = function (event) {
    ...
    if (deviceIsIOSWithBadTarget) {
      ...
      targetElement = document.elementFromPoint(touch.pageX - window
        .pageXOffset, touch.pageY - window.pageYOffset) || targetElement;
      targetElement.fastClickScrollParent = this.targetElement
    ...
    if (targetTagName === 'label') {
      ...
      if ((event.timeStamp - trackingClickStart) > 100 || (deviceIsIOS &&
          window.top !== window && targetTagName === 'input')) {
        this.targetElement = null;
        return false;
      }
      this.focus(targetElement);
  ...
  FastClick.notNeeded = function (layer) {
    ...
    if (firefoxVersion >= 27) {
      ...
      if (metaViewport && (metaViewport.content.indexOf(
          'user-scalable=no') !== -1 || document.documentElement
  ...
  if (typeof define === 'function' && typeof define.amd === 'object' && define
    .amd) {
